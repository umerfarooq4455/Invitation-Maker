...
const Header = (props: {
  ...
  return (
    <header className="sticky z-10  border-none top-0 py-1  dark:bg-[#1A222C] flex w-full ">
      <div className="flex flex-grow mx-3 shadow-md bg-white dark:border-strokedark dark:bg-boxdark  rounded-3xl items-center justify-between px-2 py-4  md:px-6 2xl:px-7">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden ">
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <img
              src={LogoIcon}
              className="w-[36px] h-[36px] rounded-lg mr-2"
              alt="Logo"
            />
          </Link>
        </div>
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative text-[#000] font-bold text-[20px] dark:text-white">
              ...
              <ul className=" items-center gap-2 2xsm:gap-4 lg:block hidden">
                {/* <!-- Dark Mode Toggler --> */}
                <DarkModeSwitcher />
                {/* <!-- Dark Mode Toggler --> */}
              </ul>
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          ...
          <ul className=" items-center gap-2 2xsm:gap-4 sm:block lg:hidden">
            <DarkModeSwitcher />
          </ul>
          <DropdownUser />
          {/* <!-- User Area --> */}
